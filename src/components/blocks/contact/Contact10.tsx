    ...
    <section className="wrapper bg-light">
      <div className="container py-14 py-md-16">
          ...
          <div className="card-body p-12">
            <div className="row gx-md-8 gx-xl-12 gy-10">
              <div className="col-lg-6">
                <Email />
                <h2 className="display-4 mb-3 pe-lg-10">Interested? Questions?<br />Send us an Email.</h2>
                <p className="lead pe-lg-12 mb-0">
                  And keep up with our current happenings on our Facebook Page!
                </p>
              </div>
        ...
        <div className="d-md-flex align-items-center justify-content-between">
          <p className="mb-2 mb-lg-0">© 2023. All rights reserved.</p>
